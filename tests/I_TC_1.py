...
username = 'cryp1' #PSA SPECIFIC SETTING
...
class test_03_connection:
	...
	def test_01_blockedConnectionNoRules(self): #PSA SPECIFIC SETTINGS
		#Pages accessed via HTTP with no translation rule are blocked
		website_address = 'http://tvtropes.org/'
		website_title = 'HomePage - TV Tropes'
		text=browser.get(raw_input(website_address))
		assert text == "The requested page can not be accessed securely", "Connecting to blocked site %s did not timeout. Could be general error in Internet connection." % website_address

	def test_02_allowedConnectionRules(self): #PSA SPECIFIC SETTINGS
		#Pages accessed via HTTP with translation rule are translated and forwarded
		website_address = 'http://security.stackexchange.com/'
		website_title = 'Information Security Stack Exchange'
	...
	def test_03_allowedConnectionGoogle(self): #PSA SPECIFIC SETTINGS
		website_address = 'https://www.google.com'
